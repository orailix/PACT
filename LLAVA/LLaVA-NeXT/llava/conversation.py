...
def safe_load_tokenizer(tokenizer_id):
    try:
        return AutoTokenizer.from_pretrained("/lustre/fsn1/projects/rech/fuv/uyb32si/HF/hub/models--meta-llama--Meta-Llama-3-8B-Instruct/snapshots/e1945c40cd546c78e41f1151f4db032b271faeaa")
    except Exception:
        return None
